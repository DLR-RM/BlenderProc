...
class UpperRegionSamplerModule(Provider):
    ...
    **Configuration**:
    ...
    def __init__(self, config):
        ...
        self._objects = MeshObject.convert_to_meshes(config.get_list("to_sample_on"))
    ...
    def run(self):
        ...
        return UpperRegionSampler.sample(
            objects_to_sample_on=self._objects,
            face_sample_range=self._face_sample_range,
            min_height=self._min_height,
            max_height=self._max_height,
            use_ray_trace_check=self._use_ray_trace_check,
            upper_dir=self._upper_dir,
            use_upper_dir=self._use_upper_dir
        )