...
class WriterUtility:
    ...
    def get_common_attribute(item: bpy.types.Object, attribute_name: str, local_frame_change: Union[None, List[str]] = None, world_frame_change: Union[None, List[str]] = None) -> Any:
        ...
        :param local_frame_change: Used to transform item to blender coordinates. Default: ["X", "Y", "Z"]
        :param world_frame_change: Used to transform item to blender coordinates. Default: ["X", "Y", "Z"]
