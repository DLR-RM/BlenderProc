...
class BasicShapeCameraSampler(CameraModule):
    ...
    def _sample_sphere(self, center, radius):
        """
        ...
        :return: A random point lying inside or on the surface of a solid sphere. Type: ndarray
        """
        ...
        return (magnitude * (direction / np.sqrt(direction.dot(direction)))) + center
