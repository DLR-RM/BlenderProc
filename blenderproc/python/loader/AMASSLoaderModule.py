...
from blenderproc.python.loader.LoaderInterface import LoaderInterface
...
class AMASSLoaderModule(LoaderInterface):
    ...
    **Configuration**:
    ...
    def __init__(self, config):
        ...
        self._data_path = Utility.resolve_path(self.config.get_string("data_path", os.path.join("resources", "AMASS")))
        # Body Model Specs
