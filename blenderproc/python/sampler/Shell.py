...
def shell(center: Union[Vector, np.ndarray, list], radius_min: float, radius_max: float, elevation_min: float, elevation_max: float, uniform_elevation: bool = False) -> np.ndarray:
