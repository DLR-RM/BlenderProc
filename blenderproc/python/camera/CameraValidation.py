...
def objects_area(cam2world_matrix: Union[Matrix, np.ndarray], bvh_tree_target: BVHTree, bvh_tree_obstacle: BVHTree, sqrt_number_of_rays: int = 10) -> Set[MeshObject]:
    ...
    return hits / (sqrt_number_of_rays ** 2), np.array(hit_points)
